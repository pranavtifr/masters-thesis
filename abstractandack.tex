...
a) Independent generation of tSZ skymaps using machine learning.
b) Cross-correlating the tSZ skymaps with weak-lensing maps.
c) Comparison with theory using Halo models.
...
\begin{acknowledgements}
  ...
  generation of tSZ skymaps using machine learning.
  \comment{thank cluster}
